...
// chenrui, 20202024
{"sm4_key_rf", 0, {"I", 0},   "d,s",  MATCH_SM4_KEY_RF, MASK_SM4_KEY_RF | MASK_IMM, match_opcode, INSN_ALIAS },
{"sm4_enc_rf", 0, {"I", 0},   "d,s",  MATCH_SM4_ENC_RF, MASK_SM4_ENC_RF | MASK_IMM, match_opcode, INSN_ALIAS },
/* Terminate the list.  */
{0, 0, {0}, 0, 0, 0, 0, 0}
};
